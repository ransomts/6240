...
**** source code
   ...
   #+begin_src C :tangle /tmp/socit-request-form.c
#include <stdio.h>
#include <ctype.h>
#include <stdlib.h>
#include <string.h>
...
*** Collect logs and add to database
  ...
  #+name: collection-log
  #+begin_src bash :results output :tangle ~/sudo-logs/ransom-pull-all.sh :shebang /bin/bash
...
*** process logs
  ...
  #+begin_src python :tangle ~/sudo-logs/parse-sudo-db.py :results output :shebang "#!/usr/bin/env python3" :cache yes :noweb no-export
